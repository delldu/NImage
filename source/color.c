...
void color_lab2rgb(float L, float a, float b, BYTE* R, BYTE* G, BYTE* B)
{
    ...
    // 0.416666 == 1.f/2.4f
    r0 = (r0 > 0.0031308f) ? (1.055f * powf(r0, 0.416666f) - 0.055f) : 12.92f * r0;
    g0 = (g0 > 0.0031308f) ? (1.055f * powf(g0, 0.416666f) - 0.055f) : 12.92f * g0;
    b0 = (b0 > 0.0031308f) ? (1.055f * powf(b0, 0.416666f) - 0.055f) : 12.92f * b0;
