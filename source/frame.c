...
{
	return (fmt == FRAME_FMT_YV12 || fmt == FRAME_FMT_YUV420 ||
			fmt == FRAME_FMT_YUV420P || fmt == FRAME_FMT_YUV422 ||
			fmt == FRAME_FMT_YUV422P || fmt == FRAME_FMT_YUV444 ||
			fmt == FRAME_FMT_YUV444P || fmt == FRAME_FMT_RGB24 || fmt == FRAME_FMT_RGBA32);
}
